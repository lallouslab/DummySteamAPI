...
struct ISteamGameServer012Vtbl
{
	...
	MEMBER void (*ClearAllKeyValues)(struct ISteamGameServer *iface);
...
#define ISteamGameServer012_GetSteamID(iface, ret) DSA_CALL_MEMBER_RETURN_STRUCT0(iface->vtbl.v012->GetSteamID, ret, iface)
#define ISteamGameServer012_CreateUnauthenticatedUserConnection(iface, ret) DSA_CALL_MEMBER_RETURN_STRUCT0(iface->vtbl.v012->CreateUnauthenticatedUserConnection, ret, iface)
